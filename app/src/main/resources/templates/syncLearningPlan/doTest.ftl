...
<div class="pageContent">
    ...
    <div style="float: right;width: 35%;height: 100%;"  layoutH="25">
        ...
        <#--<form method="post" enctype="multipart/form-data" action="${ctx}/syncTest/studentAnswer/save"  class="pageForm required-validate"  onsubmit="return iframeCallback(this, navTabAjaxDone);" >-->
            <form id="form1" method="post" enctype="multipart/form-data" action="${ctx}/syncTest/studentAnswer/save"  class="pageForm required-validate" onsubmit="return navTabSearch(this);">
            <input type="hidden" name="testId" value="${syncTestDO.id!}">
            <input type="hidden" name="xztNum" value="${syncTestDO.xztNum!}">
            <div class="pageFormContent" >
                <dl class="nowrap">
                    <#list 1..syncTestDO.xztNum as num>
                        <dt>第${num}题：</dt>
                        <dd>
                            <div>
                                <input type="text" name="xztAnswer${num}"/>
                ...
                <dl class="nowrap">
                    ...
                    <dd>
                        <div>
                            <textarea style="height: 500px;width: 320px" name="tkjsAnswer"></textarea>
                        </div>
                    </dd>
                </dl>
                ...
                <div class="formBar">
                    <ul>
                        <li style="text-align: center"><div class="buttonActive"><div class="buttonContent"><button id="save" type="submit" >提交答案</button></div></div></li>
