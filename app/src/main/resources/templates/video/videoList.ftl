...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="${ctx}/courseWare/video/prepareAdd?typeid=${typeid}" target="navTab"><span>增加</span></a></li>
        </ul>
    </div>
    </#if>
            ...
            <tr align="center">
                ...
                <td>
                    <#--<object align=middle class=OBJECT classid=CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95 height=320 id=MediaPlayer width=356>
                        ...
                        <a href="${ctx}/courseWare/video/playVideo?url=${courseWare.url}" onclick="openWord(${courseWare.url!})" target="_blank">${courseWare.name!}</a>
                </td>
                ...
                <td>
                    ...
                    <#if (role<2)>
                    <!-- 修改 -->
                    <#--<a  style="color:blue" href="${ctx}/courseWare/video/prepareUpdate?id=${courseWare.id}" target="navTab">修改</a>-->
                    <!-- 作废 -->
                    <a style="color:blue" href="${ctx}/courseWare/video/delete?id=${courseWare.id}" target="ajaxTodo" title="温馨提示：是否确认删除" >删除</a>
                    </#if>
                </td>
