...
(function($){
	if ($.validator) {
		//znd add
        $.validator.addMethod("criterionEmail", function(value, element) {
            return this.optional(element) ||/^([a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+))+$/gi.test(value);
        }, "Sorry");
        $.validator.addMethod("chineseAndEnglishAndNumberAndUnderline", function(value, element) {
            return this.optional(element) ||/^[\u4e00-\u9fa5a-zA-Z0-9_]+$/gi.test(value);
        }, "Sorry");
		$.validator.addMethod("chineseAndEnglishAndNumber", function(value, element) {
			return this.optional(element) || /^[\u4e00-\u9fa5a-z0-9]+$/gi.test(value);
		}, "Sorry");
